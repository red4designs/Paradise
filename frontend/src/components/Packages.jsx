...
const Packages = () => {
  ...
  return (
    <section id="packages" className="section-padding bg-transparent">
        ...
        <PerformanceOptimizer>
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {mockData.packages.map((pkg, index) => (
              <Card key={pkg.id} className={`bg-white/5 border-white/25 dark-hover dark-transition relative overflow-hidden ${index === 1 ? 'border-brand-primary/50 transform lg:scale-105' : ''
                }`}>
                {index === 1 && (
