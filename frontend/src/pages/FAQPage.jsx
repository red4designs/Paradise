  ...
  return (
    <div className="bg-sand min-h-screen pt-24 pb-32">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-20 fade-in-up">
        <span className="uppercase tracking-[0.2em] text-xs font-medium text-forest/60 block mb-4">Support</span>
        ...
        {faqs.map((faq, index) => {
          ...
          return (
            <div key={index} className="border-b border-forest/10">
              ...
              >
                <h3 className={`font-serif text-xl transition-colors ${isOpen ? 'text-forest' : 'text-forest/80 group-hover:text-forest'}`}>
                  {faq.question}
                </h3>
                <span className="text-forest/50 ml-4 shrink-0 transition-transform duration-300">
              ...
              >
                <p className="text-forest/70 font-light leading-relaxed pl-4 border-l border-forest/20">
                  {faq.answer}
                </p>
              </div>
            </div>
